...
constexpr UINT WM_DELETE_WK_DNS_FROM_WK_DNS = WM_APP + 4;
constexpr UINT WM_DELETE_WK_GQCS_DNS_FROM_WK_GQCS_DNS = WM_APP + 5;

constexpr UINT WM_FINISHED_WK_DELETE = WM_APP + 6;
constexpr UINT WM_FINISHED_APPCONTEXT_DELETE = WM_APP + 7;

constexpr LPARAM HINT_UPDATE_VEC_BLOCK_DOMAIN = WM_APP + 8;
constexpr LPARAM HINT_INSERT_BLOCK_DOMAIN = WM_APP + 9;
constexpr LPARAM HINT_DELETE_BLOCK_DOMAIN = WM_APP + 10;
constexpr LPARAM HINT_DELETE_WFP_CTRL = WM_APP + 11;
